...
cost=Label(text="Разом, грн.",font=("Arial",12,"bold"))
cost.place(x=310,y=20)


lbl1=Label(text="Піца",font=("Arial",12))
lbl1.place(x=20,y=60)


lbl2=Label(text="Морозиво",font=("Arial",12))
lbl2.place(x=20,y=100)


lbl3=Label(text="Тістечко",font=("Arial",12))
lbl3.place(x=20,y=140)


lbl4=Label(text="Сік",font=("Arial",12))
lbl4.place(x=20,y=180)


p1=Entry(font="Arial 12",bg="grey",justify="center")
p1.insert(END,"75")
p1.place(x=150,y=60,width=60,height=30)


p2=Entry(font="Arial 12",bg="grey",justify="center")
p2.insert(END,"12")
p2.place(x=150,y=100,width=60,height=30)


p3=Entry(font="Arial 12",bg="grey",justify="center")
p3.insert(END,"16")
p3.place(x=150,y=140,width=60,height=30)


p4=Entry(font="Arial 12",bg="grey",justify="center")
p4.insert(END,"8")
...
var1=StringVar()
c1=Label(text=0,font="Arial 12",bg="grey",textvariable=var1)
c1.place(x=310,y=60,width=60,height=30)

var2=StringVar()
c2=Label(text=0,font="Arial 12",bg="grey",textvariable=var2)
c2.place(x=310,y=100,width=60,height=30)

var3=StringVar()
c3=Label(text=0,font="Arial 12",bg="grey",textvariable=var3)
c3.place(x=310,y=140,width=60,height=30)

var4=StringVar()
c4=Label(text=0,font="Arial 12",bg="grey",textvariable=var4)
c4.place(x=310,y=180,width=60,height=30)



lbl5=Label(text="Разом",font=("Arial",12))
lbl5.place(x=20,y=240)

var5=StringVar()
c5=Label(text=0,font="Arial 12",bg="grey",textvariable=var5)
c5.place(x=200,y=240,width=60,height=30)


lbl6=Label(text="грн",font=("Arial",12))
